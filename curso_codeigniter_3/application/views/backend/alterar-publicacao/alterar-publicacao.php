                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" id="txt-titulo" name="txt-titulo" class="form-control" placeholder="Informe o Título da publicação" value="<?php echo $publicacao->titulo; ?>">
                                    </div>
                                    <div class="form-group">
                                            <label id="txt-subtitulo">Subtítulo</label>
                                            <input type="text" id="txt-subtitulo" name="txt-subtitulo" class="form-control" placeholder="Digite o email do usuário..." value="<?php echo $publicacao->subtitulo; ?>">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <?php 
                                        ...
                                        echo $divclose;
                                        echo $divopen;
                                        $botao= array('name' => 'btn_adicionar', 'id' => 'adicionar', 'class' => 'btn btn-default', 'value' => 'Adcionar nova Imagem');
