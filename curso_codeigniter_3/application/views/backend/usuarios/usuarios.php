                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" id="txt-user" name="txt-user" class="form-control" placeholder="Digite o username..." value="<?php echo set_value('txt-user') ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <label id="txt-conf-senha">Confirmar Senha</label>
                                            <input type="password" id="txt-conf-senha" name="txt-conf-senha" class="form-control" >
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    foreach($usuarios as $usuario){
                                       ...
                                       $alterar=anchor(base_url('admin/usuarios/alterar/'.md5($usuario->id)),'<i class="fa fa-pencil fa-fw"></i>Alterar');
                                       $excluir=anchor(base_url('admin/usuarios/excluir/'.md5($usuario->id)),'<i class="fa fa-trash fa-fw"></i>Excluir');
